...
// ─── ROOT AUTH WRAPPER ────────────────────────────────────────────────────────
// Drop this component in place of your Tradr component in main.tsx / App.tsx.
// It handles auth state and only renders Tradr when the user is signed in.
//
// Usage in main.tsx:
//   import TradrAuth from "./TradrAuth";
//   ReactDOM.createRoot(...).render(<TradrAuth />);

import Tradr from "./TRADR"; // adjust path to your main app file
...
export default function TradrAuth() {
  ...
  // Signed in → show the app, pass user so Tradr can use it
